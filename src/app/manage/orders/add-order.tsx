...
export default function AddOrder() {
  ...
  const totalPrice = useMemo(() => {
    return dishes.reduce((result: number, dish: { id: number; price: number }) => {
  ...
  const handleNewGuestOrder = (async () => {
  ...
  const handleOldGuestOrder = () => {
    ...
    if (!guestId) {
      toast.success('Hãy chọn một khách hàng')
      return
    }
    createOrder(guestId)
  }
